    ...
    <section class="signup-section py-5">
        <div class="container">
            <div class="main-head text-center mb-5">
                ...
                <p class="text-muted">To contact us simply fill the form below.
                </p>
                <p class="text-muted">
                    Please take a minute reading both our <a href="./about-us.html" class="brief-link">Faqs</a> and
                    our <a href="./tos.html" class="brief-link">TOS</a> before
                    sending any messages regarding our services.
